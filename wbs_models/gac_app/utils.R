...
calculate_autosize_bed_depth <- function(design_flow_mgd,
  ...
  if (exists("vessel_thickness")) message(sprintf("[vessel_thickness debug] vessel_thickness    = %s", vessel_thickness))
  if (exists("inner_diameter"))   message(sprintf("[inner_diameter debug] inner_diameter    = %s", inner_diameter))
